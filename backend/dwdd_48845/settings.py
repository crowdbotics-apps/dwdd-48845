"""
Django settings for dwdd_48845 project.
...
WSGI_APPLICATION = 'dwdd_48845.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "dwdd Support <support@dwdd-48845.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dwdd_48845 API",
    "DESCRIPTION": "API documentation for dwdd_48845 App",
    "VERSION": "v1",
}
